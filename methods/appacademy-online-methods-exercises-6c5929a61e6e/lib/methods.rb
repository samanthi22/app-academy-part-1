...
def dec_remainder_of_two_integers(i_dividend, i_divisor)
    i_dividend = i_dividend.to_f
    i_divisor = i_divisor.to_f
    return dec_remainder_of_two_floats(i_dividend, i_divisor)
end
...
def int_remainder_without_modulo(i_dividend, i_divisor)
    return (dec_remainder_of_two_integers(i_dividend, i_divisor) * i_dividend * i_divisor / i_dividend).round
end
